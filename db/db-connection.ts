...
import { tenantEntity } from "./db-schema";
...
/** Drizzle for the primary DB (registry / single-tenant DB). */
export function get_core_db() {
  return tenantEntity
    ? drizzle({ client: getCorePool(), schema: { tenantEntity } })
...
export { APP_SCHEMA, tenantEntity } from "./db-schema";
